...
<head>
    ...
    <title>30 Days to Laravel</title>
...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="https://laracasts.com/images/lary-ai-face.svg" alt="Lary the AI bot">
            </div>
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Lary AI</div>
                <div class="text-sm font-medium leading-none text-gray-400">lary@laravel.com</div>
            </div>
